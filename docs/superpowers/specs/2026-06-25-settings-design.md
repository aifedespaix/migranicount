...
[data-theme="dark"] { /* existing dark values, moved out of the media query, unchanged */ }
...
[data-font="lexend"] body { font-family: 'Lexend', system-ui, -apple-system, sans-serif; }
[data-font="opendyslexic"] body { font-family: 'OpenDyslexic', system-ui, -apple-system, sans-serif; }
```
